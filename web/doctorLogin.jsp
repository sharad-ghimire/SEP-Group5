            ...
            <div class="col s12 m5 offset-m4">
                <div class="card">
                    ...
                    <div class="card-content">
                       <span class="card-title">Doctor Log In</span>
                       <form method="post" action="doctorLogin.jsp">
                           ...
                           <div class="form-field">
                            ...
                            <div class="form-field">
                                <button onclick="location.href='studentLogin.jsp'" class="btn-large  blue darken-1 white-text" name="submitForDoctor" style="width: 100%">
                                Login As Student
                                </button>
                           </div><br>
                       </form>
